			...
			<form id="form_validation" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group form-float">
					<div class="form-line">
						...
						<label class="form-label">Nomor Identitas KTP/NIM/NIP...</label>
					</div>
				</div>
				<div class="form-group form-float">
					<div class="form-line">
				...
				<div class="card" style="border-radius: 10px;">
					<div class="header" align="center">
						<table align="center" class="atas responsive">
							<th>
								<img src="gambar/LGP.png" class="img-circle" alt="Cinque Terre" width="50" height="45"></th> 
							</th>
							<th>
				...
				<div class="card" style="border-radius: 10px;">
					<div class="body">
						...
						<div class="isicatatan">
							<ol>
								<li>Kartu Anggota ini harus dibawa setiap kunjungan, pinjaman, pengembalian kepondok Baca.</li>
